...
import tempDecoder.temp_decoder as TD
...
_keys = ['sub_category', 'wmo_block_no', 'wmo_station_no', 'ship_or_mobile_land_id',
...
MAPPINGS = f"{THISDIR}{os.sep}resources{os.sep}309052_mapping.json"
...
def parse_temp(message: str, year: int, month: int) -> dict:
    ...
    #   Need to keep track of how many replications there for this group
    ...
    for message in messages:
        ...
        try:
            ...
            if msg['wmo_block_no'] is not None and msg['wmo_station_no'] is not None:
                tsi = str(msg['wmo_block_no']) + str(msg['wmo_station_no'])
